...
public final class FragmentTodoBinding implements ViewBinding {
  ...
  private FragmentTodoBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton fabAddTask, @NonNull RecyclerView recyclerViewTask,
      @NonNull TextView textListEmpty) {
  ...
  public static FragmentTodoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTodoBinding((ConstraintLayout) rootView, fabAddTask, recyclerViewTask,
          textListEmpty);
    }
